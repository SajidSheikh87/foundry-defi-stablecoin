...
/**
 * @title OracleLib
 * @author Sajid SheikhThis library is used to check the Chainlink Oracle for stale data.
...
library OracleLib {
    ...
    function staleCheckLatestRound(AggregatorV3Interface priceFeed) public view returns (uint80, int256, uint256, uint256, uint80) {
